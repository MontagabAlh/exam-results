...
export default function Home() {
  ...
  const fetchResults = async () => {
    ...
    try {
      const response = await fetch("/api/proxy/education", {
        method: "POST",
  ...
  const Specialties = [
    { name: 'معلم صف', value: 1 },
    { name: 'رياض أطفال', value: 2 },
    { name: 'ارشاد نفسي', value: 3 },
    { name: 'مناهج و طرائق تدريس', value: 4 },
    { name: 'علم النفس', value: 5 },
    { name: 'دبلوم', value: 6 },
  ]
  return (
    <div className="bg-gray-900 text-gray-100 font-droid font-cairo relative">
      ...
      <main className="container mx-auto px-4 pt-16 pb-8 ">
        <h1 className="text-center text-lg font-bold mb-5">كلية التربية - جامعة حمص </h1>
