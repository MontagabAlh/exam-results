...
export default function Home() {
  ...
  const fetchResults = async () => {
    ...
    try {
      const response = await fetch("/api/proxy/applied", {
        method: "POST",
  ...
  const Specialties = [
    { name: 'تقنيات حاسوب', value: 1 },
    { name: 'تدفئة وتكييف', value: 2 },
  ]
  return (
    <div className="bg-gray-900 text-gray-100 font-droid font-cairo relative">
      ...
      <main className="container mx-auto px-4 pt-16 pb-8 ">
        <h1 className="text-center text-lg font-bold mb-5">الكلية التطبيقية - جامعة حمص </h1>
