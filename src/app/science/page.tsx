...
export default function Home() {
  ...
  const fetchResults = async () => {
    ...
    try {
      const response = await fetch("/api/proxy/science", {
        method: "POST",
  ...
  const Specialties = [
    { name: 'كيمياء', value: 1 },
    { name: 'فيزياء', value: 2 },
    { name: 'رياضيات', value: 3 },
    { name: 'علم حياة', value: 4 },
    { name: 'إحصاء', value: 5 },
    { name: 'جيولوجيا', value: 6 },
  ]
  return (
    <div className="bg-gray-900 text-gray-100 font-droid font-cairo relative">
      ...
      <main className="container mx-auto px-4 pt-16 pb-8 ">
        <h1 className="text-center text-lg font-bold mb-5">كلية العلوم - جامعة حمص </h1>
